...
import {
  ContentAgent,
  ContentAgentConfig,
} from '../implementations/ContentAgent';
import {
  OutreachAgent,
  OutreachAgentConfig,
} from '../implementations/OutreachAgent';
import {
  AdOptimizerAgent,
  AdOptimizerConfig,
} from '../implementations/AdOptimizerAgent';
import {
  TrendPredictorAgent,
  TrendPredictorConfig,
} from '../implementations/TrendPredictorAgent';
    ...
    switch (dbAgent.agentType) {
      ...
      case AgentType.OUTREACH_MANAGER:
        agent = new OutreachAgent(
          agentId,
          config as OutreachAgentConfig,
          this.prisma,
        );
        break;

      case AgentType.PERFORMANCE_OPTIMIZER:
        agent = new AdOptimizerAgent(
          agentId,
          config as AdOptimizerConfig,
          this.prisma,
        );
        break;

      case AgentType.TREND_ANALYZER:
        agent = new TrendPredictorAgent(
          agentId,
          config as TrendPredictorConfig,
          this.prisma,
        );
        break;
