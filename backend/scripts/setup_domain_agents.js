...
const engineeringDomains = [
  {
    ...
    description: 'Specializes in frontend technologies, frameworks, UI/UX implementation, and responsive design.',
    domainContext: 'frontend development',
    initialPrompt: 'What are the current best practices for building performant and accessible frontend applications?'
  },
  {
    name: 'Backend Development',
    description: 'Focused on server-side architecture, API design, database management, and scalability.',
    domainContext: 'backend development',
    initialPrompt: 'What are the most effective patterns for designing scalable and maintainable APIs?'
  },
  {
    name: 'DevOps Engineering',
    description: 'Expertise in CI/CD pipelines, infrastructure as code, containerization, and cloud services.',
    domainContext: 'DevOps engineering',
    initialPrompt: 'What are the key considerations for setting up a modern CI/CD pipeline with infrastructure as code?'
  },
  {
    name: 'Database Architecture',
    description: 'Focused on database design, optimization, migration strategies, and data modeling.',
    domainContext: 'database architecture and management',
    initialPrompt: 'What are the tradeoffs between different database types and when should each be used?'
  },
  {
    name: 'Mobile Development',
    description: 'Specializes in native and cross-platform mobile app development strategies and patterns.',
    domainContext: 'mobile app development',
    initialPrompt: 'What are the current best approaches for developing cross-platform mobile applications?'
  },
  {
    name: 'Security Engineering',
    description: 'Focused on application security, secure coding practices, pen testing, and threat modeling.',
    domainContext: 'application security and secure coding',
    initialPrompt: 'What are the OWASP top 10 vulnerabilities and how can developers mitigate them?'
  },
  {
    name: 'Machine Learning Engineering',
    description: 'Specializes in ML model development, deployment, monitoring, and MLOps.',
    domainContext: 'machine learning engineering and MLOps',
    initialPrompt: 'What are the best practices for deploying and monitoring machine learning models in production?'
  }
];
  ...
  try {
    ...
    if (!project) {
      ...
      project = await prisma.project.create({
        data: {
          name: 'Engineering Domains',
          description: 'Specialized engineering domain conversations for different software sectors',
          owner: {
