...
exports.getSentimentSummary = exports.deleteFeedback = exports.updateFeedback = exports.createFeedback = exports.getFeedback = exports.getAllFeedback = void 0;
...
const getAllFeedback = async (req, res) => {
    try {
        const { userId, sourceType, sourceId, sentiment, channel, startDate, endDate, } = req.query;
...
const createFeedback = async (req, res) => {
    try {
        const { content, sentiment, sourceType, sourceId, channel, contentId, outreachTaskId, } = req.body;
        const userId = req.user.id;
