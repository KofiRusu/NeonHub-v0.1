...
describe('CampaignService', () => {
    let campaignService;
    beforeEach(() => {
        campaignService = new CampaignService_1.CampaignService(mockPrisma);
        jest.clearAllMocks();
    });
    ...
    describe('createCampaign', () => {
        it('should create a new campaign', async () => {
            ...
            mockPrisma.campaign.create.mockResolvedValueOnce(mockCampaign);
    ...
    describe('updateCampaign', () => {
        it('should update a campaign without agent changes', async () => {
            ...
            mockPrisma.campaign.update.mockResolvedValueOnce(mockCampaign);
        ...
        it('should update a campaign with agent changes', async () => {
            ...
            mockPrisma.campaign.findUnique.mockResolvedValueOnce(mockExistingCampaign);
            mockPrisma.campaign.update.mockResolvedValueOnce(mockUpdatedCampaign);
            const result = await campaignService.updateCampaign(campaignId, updateData);
            expect(mockPrisma.campaign.findUnique).toHaveBeenCalledWith({
                where: { id: campaignId },
                include: { agents: true },
    ...
    describe('deleteCampaign', () => {
        it('should delete a campaign', async () => {
            const campaignId = 'campaign-123';
            const mockCampaign = { id: campaignId, name: 'Test Campaign' };
            mockPrisma.campaign.delete.mockResolvedValueOnce(mockCampaign);
