...
router.get(
  ...
  feedback_controller_1.getAllFeedback,
);
/**
...
router.get(
  '/sentiment-summary',
  auth_middleware_1.protect,
  feedback_controller_1.getSentimentSummary,
);
/**
...
router.get(
  '/:id',
  auth_middleware_1.protect,
  feedback_controller_1.getFeedback,
);
/**
...
router.post(
  '/',
  auth_middleware_1.protect,
  feedback_controller_1.createFeedback,
);
/**
...
router.put(
  '/:id',
  auth_middleware_1.protect,
  feedback_controller_1.updateFeedback,
);
/**
...
router.delete(
  '/:id',
  auth_middleware_1.protect,
  feedback_controller_1.deleteFeedback,
);
