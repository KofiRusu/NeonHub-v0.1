...
router.post('/generate', [
    ...
    (0, express_validator_1.body)('tone').isString().notEmpty().withMessage('Tone is required'),
    (0, express_validator_1.body)('length').isString().notEmpty().withMessage('Length is required'),
], async (req, res) => {
    ...
    try {
        const { title, contentType, campaignId, platform, targeting, keyPoints, tone, length, } = req.body;
