...
export declare abstract class BaseAgent {
     ...
     */
    protected logEvent(type: AgentEventType, message: string, data?: any, level?: 'info' | 'warning' | 'error'): void;
    /**
     * Log a message to the agent's execution log (legacy method for backward compatibility)
     * @param message The message to log
     * @param level Log level
     */
    protected logMessage(message: string, level?: 'info' | 'warning' | 'error'): Promise<void>;
    /**
