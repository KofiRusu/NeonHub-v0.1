...
const agent_routes_1 = __importDefault(require("./routes/agents/agent.routes"));
...
app.use('/api/campaigns', auth_1.authenticateToken, campaigns_routes_1.default);
app.use('/api/metrics', auth_1.authenticateToken, metric_routes_1.default);
