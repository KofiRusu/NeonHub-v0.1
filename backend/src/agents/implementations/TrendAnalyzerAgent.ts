import { PrismaClient, AIAgent, SignalType, TrendImpact } from '@prisma/client';
  ...
  > {
    ...
    for (let i = 0; i < Math.min(keywords.length, 5); i++) {
      ...
      trends.push({
        ...
        signalType: 'OPPORTUNITY' as SignalType,
        impact: 'MEDIUM' as TrendImpact,
    ...
    trends.push({
      ...
      signalType: 'THREAT' as SignalType,
      impact: 'HIGH' as TrendImpact,
    ...
    trends.push({
      ...
      signalType: 'SHIFT' as SignalType,
      impact: 'MEDIUM' as TrendImpact,
