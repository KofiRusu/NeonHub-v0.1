                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="10 Ways to Improve Your Marketing ROI" {...field} />
                      </FormControl>
                      <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Marketing professionals aged 25-45" {...field} />
                      </FormControl>
                      <FormDescription>
                    ...
                    <AccordionContent>
                      <div className="space-y-4 pt-2">
                        <p className="text-sm text-muted-foreground">
                          Additional options will be available in a future update
                        </p>
                      </div>
                    </AccordionContent>
                  </AccordionItem>
        ...
        <Card>
          ...
          <CardContent>
            {isGenerating ? (
              ...
              <div className="flex flex-col items-center justify-center h-96">
                <p className="text-center text-muted-foreground">
                  Configure the parameters and click "Generate Content" to create your content
                </p>
              </div>
            )}
          </CardContent>
