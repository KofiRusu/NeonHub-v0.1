...
const campaignSchema = z.object({
  ...
  type: z.enum(['CONTENT_MARKETING', 'EMAIL_CAMPAIGN', 'SOCIAL_MEDIA', 'SEO_OPTIMIZATION', 'AD_CAMPAIGN', 'PRODUCT_LAUNCH', 'EVENT_PROMOTION', 'BRAND_AWARENESS']),
    ...
    <div className="container mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Create an AI-powered marketing campaign with smart content generation and outreach
        </p>
      </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Young professionals aged 25-34" {...field} />
                    </FormControl>
                    <FormDescription>
